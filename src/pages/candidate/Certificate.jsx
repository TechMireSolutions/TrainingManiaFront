...
const Certificate = () => {
    ...
    useEffect(() => {
        // Load Candidate
        const candidateStored = localStorage.getItem('current_candidate');
        if (!candidateStored) {
            navigate('/candidate/login');
            return;
        }
        const candidate = JSON.parse(candidateStored);
        // Determine name: use 'name' if available, otherwise email prefix, or allow edit
        ...
        const training = allTrainings.find(t => t.id.toString() === id);
